...
int     PLECanvasSizeDialogPrivate::WIDTH_PIXEL           = 800;
int     PLECanvasSizeDialogPrivate::HEIGHT_PIXEL          = 800;
...
{
    sizeLabel->setText(QString::number(WIDTH_PIXEL).append(QLatin1String(" x ")).append(QString::number(HEIGHT_PIXEL).append(QLatin1String(" px"))));
}
...
{
    setupDialog(QSize(d->WIDTH_PIXEL, d->HEIGHT_PIXEL),
                d->currentSizeUnit,
...
void PLECanvasSizeDialog::setHorizontal(bool isHorizontal)
{
    ...
    d->horizontalButton->setChecked(d->WIDTH_PIXEL > d->HEIGHT_PIXEL);
    d->verticalButton->setChecked(d->WIDTH_PIXEL < d->HEIGHT_PIXEL);
}
